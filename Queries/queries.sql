...
--create new table to store retirement info
SELECT first_name, last_name
...
--Use Alias, shortens code for readibility
SELECT d.dept_name,
	dm.emp_no,
	dm.from_date,
	dm.to_date
...
--List #1: Employee Information: A list of employees 
--containing their unique employee number, their 
...
--List #3: Department Retirees: An updated current_emp list 
--that includes everything it currently has, but also the 
...
--Create query for Sales & Development teams
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
